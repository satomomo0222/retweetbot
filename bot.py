...
# リツイート対象アカウントを指定
users = ["youtubemasterd7", "yako_tera", "mon_youtubeking", "KoolNero", "bazyama", "J1nTube", "afro_three", "naaachanel_", "zirazirakuzira", "yt_map"]
#YoutubeマスターD, ヤコ, もん, 野良ネロ, バズ山, じん, アフロ, なーちゃんねる, YouTubeくじら, 生パスタ
